...
bool ESP8266WiFiSTAClass::_smartConfigDebug = false;

/**
 * Start SmartConfig
 */
bool ESP8266WiFiSTAClass::beginSmartConfig(uint8 timeout, bool debug = false) {
	_smartConfigDebug = debug;
...
int ESP8266WiFiSTAClass::getSmartConfigStatus() {
	return smartConfigSt;
}
